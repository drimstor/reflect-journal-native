...
import Select from "../Select/Select.android";
import Text from "../Text/Text";
import { createStyles } from "./MonthYearPicker.android.styles";
import { MonthYearPickerProps, MonthYearValue } from "./model/types";

const MonthYearPickerAndroid: FC<MonthYearPickerProps> = ({
  value = {},
  label,
  helperText,
  backgroundColor,
...
export default memo(MonthYearPickerAndroid);
